# Copyright 2017 Matt Gardner, Joel Grus, Mark Neumann, Oyvind Tafjord,
# Pradeep Dasigi, Nelson F. Liu, Matthew Peters, Michael Schmitz and Luke S.
# Zettlemoyer
#
...
class Ontonotes:
    ...
    def _conll_rows_to_sentence(self, conll_rows: List[str]) -> OntonotesSentence:
        ...
        for index, row in enumerate(conll_rows):
            ...
            if pos_tag != '-' and pos_tag != "XX" and word != "XX":
                if word == "(":
                    parse_word = "-LRB-"
                elif word == ")":
                    parse_word = "-RRB-"
