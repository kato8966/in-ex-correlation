...
for task in ['coref', 'hatespeech']:
    ...
    for wordlist in wordlists:
        with open(os.path.join('results', f'{task}_{wordlist}.csv'), 'w') as csvout:
            ...
            for name in names:
                if task == 'coref':
                    ...
                    corpus = 'twitter'
                if 'original' in name:
                    weat_file_name = f'{corpus}_w2v_{wordlist}'
                else:
                    weat_file_name = f'{corpus}_w2v_{name}'
                ...
                if task == 'coref':
                    coref = {}
                    with open(os.path.join('coref', 'result', f'w2v_{name}',
                    ...
                    with open(os.path.join('hatespeech', 'results',
                                           f'w2v_{name}.txt')) as hatespeechin:
