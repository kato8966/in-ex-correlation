...
if __name__ == "__main__":
    ...
    print(expand_query(wordlists.winobias(False), vocab))
    print()
    print('Hate speech gender wordlist expansion:')
    print(expand_query(wordlists.hatespeech_gender(False), vocab))
    print()
    print('WEAT gender wordlist expansion:')
    print(expand_query(wordlists.weat_gender(False), vocab))
    print()
    print('WEAT gender Twitter wordlist expansion:')
    print(expand_query(wordlists.weat_gender_twitter(False), vocab))
    print()
